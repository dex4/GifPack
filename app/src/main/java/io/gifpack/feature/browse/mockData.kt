...
val fromSoftwarePacks = listOf(
    GifPackData(6, "https://picsum.photos/id/12/200/200", "Dark Souls 2"),
    GifPackData(7, "https://picsum.photos/id/22/200/200", "Elden Ring", "Big Dark Souls"),
    GifPackData(8, "https://picsum.photos/id/32/200/200", "Armored Core"),
    GifPackData(9, "https://picsum.photos/id/42/200/200", "Dark Souls: Remastered", "60fps!"),
    GifPackData(10, "https://picsum.photos/id/52/200/200")
)

val cdProjektRed = listOf(
    GifPackData(11, "https://picsum.photos/id/13/200/200", "The Witcher 2"),
    GifPackData(12, "https://picsum.photos/id/23/200/200", "The Witcher 3", "Silver Swords"),
    GifPackData(13, "https://picsum.photos/id/33/200/200", "Cyberpunk 2077"),
    GifPackData(14, "https://picsum.photos/id/43/200/200", "The Witcher 3", "The Wild Hunt Best Of Eredin")
)

val hollowKnight = listOf(
    GifPackData(15, "https://picsum.photos/id/14/200/200", "Zote"),
    GifPackData(16, "https://picsum.photos/id/24/200/200", description = "Road to Hallownest - Run through Forgotten Crossroads"),
    GifPackData(17, "https://picsum.photos/id/34/200/200", "Cornifer"),
    GifPackData(18, "https://picsum.photos/id/44/200/200", "Pantheon", "Most awesome combos")
)
